...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/skills-93-green?style=flat-square" />
  <img src="https://img.shields.io/badge/commands-10-blue?style=flat-square" />
...
- **结构化两阶段工作流** — 选题准备（选刊→定方案）→ 研究写作（调研→实验→发表）
- **5 个专职 agent 角色** — 各自有独立记忆和明确职责
- **93 个内置研究技能** — 从论文搜索到期刊选刊，从实验设计到图表生成
- **期刊选刊系统** — 英文 SCI/SSCI + 中文北核/CSSCI 双路线，支持掠夺刊筛查
...
```bash
# 阶段一：选题准备（写作前）
/journal-research-orchestrator     # 选刊（英文 SCI/SSCI）
# 或 /cn-orchestrator              # 选刊（中文核心）
...
选刊是写作前的准备阶段——确定目标期刊后，再围绕期刊要求规划研究方案和实验设计。

---

## 期刊选刊

v0.3.0 新增的期刊选刊系统，支持英文和中文双路线。
...
| **期刊选刊（EN）** | `journal-research-orchestrator` · `ai-journal-match` · `openalex-explore` · `crossref-validator` · `letpub-sci-journal-review` · `predatory-risk-check` |
| **期刊选刊（CN）** | `cn-orchestrator` · `cn-discover-by-catalog` · `cn-discover-by-paper` · `easyscholar-rank` · `muchong-cn-journal-review` · `nppa-validator` |
